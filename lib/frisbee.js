...
var Frisbee = function () {
  ...
  (0, _createClass3.default)(Frisbee, [{
    ...
    value: function jwt(token) {
      if (token === null) delete this.headers.Authorization;else if (typeof token === 'string') this.headers.Authorization = 'JWT ' + token;else throw new Error('jwt token must be a string');
